...
namespace Benga {
	...
	void EditorLayer::OnAttach() {
		...
		Benga::FramebufferSpecs fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Benga::Framebuffer::Create(fbSpec);
	}
	...
	void EditorLayer::OnUpdate(Benga::Timestep ts) {
	...
	void EditorLayer::OnImGuiRender() {
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Benga::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Benga::Event& e) {
